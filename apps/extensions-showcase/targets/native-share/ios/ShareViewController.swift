...
class ShareViewController: UIViewController {
    private let appGroup = "group.com.test.extensionsshowcase"
    ...
    private func setupUI() {
        ...
        titleLabel = UILabel()
        titleLabel.text = "Native Share Extension"
    ...
    private func saveToUserDefaults() {
        ...
        if let jsonString = defaults.string(forKey: "nativeShare:items"),
        ...
        if let jsonData = try? JSONEncoder().encode(items),
           let jsonString = String(data: jsonData, encoding: .utf8) {
            defaults.set(jsonString, forKey: "nativeShare:items")
    ...
    @objc private func openAppTapped() {
        ...
        guard let urlScheme = URL(string: "extensionsshowcase://open") else {
