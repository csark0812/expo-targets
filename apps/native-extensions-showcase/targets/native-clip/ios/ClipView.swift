        ...
        ZStack {
            ...
            VStack(spacing: 24) {
                ...
                VStack(spacing: 8) {
                    ...
                    Text("Lightweight native experience")
                        .font(.subheadline)
                ...
                VStack(spacing: 12) {
                    ...
                    Button(action: {
                        // Open full app
                        if let url = URL(string: "nativeextensionsshowcase://checkout") {
                ...
                HStack {
                    Image(systemName: "app.badge")
                        .font(.caption)
                    Text("This is a native App Clip")
                        .font(.caption)
                }
                .foregroundColor(.secondary)
                .padding(.bottom, 20)
...
#Preview {
    ClipView(invocationURL: URL(string: "https://nativeextensionsshowcase.example.com?item=Premium%20Item&price=29.99"))
}
