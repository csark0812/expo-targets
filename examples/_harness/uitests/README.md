...
| ------------------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------ |
| **C1** XCUITest attach-after-prebuild | UI tests survive `npx expo prebuild --platform ios` regenerate and prove the system Share Sheet is **interactable** (open sheet, extension row hittable, dismiss). `testShareExtensionLaunches` additionally proves Release embeds JS so the appex UI appears. | **Stop and re-grill** before merging PR C. Do not fall back to in-process-only, Maestro-Share-Sheet, or clip-only. |
