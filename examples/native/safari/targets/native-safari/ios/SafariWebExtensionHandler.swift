...
/// Native message handler for NativeSafari example.
class SafariWebExtensionHandler: NSObject, NSExtensionRequestHandling {
  private let appGroup = "group.com.expotargets.example.native.safari"
  ...
  func beginRequest(with context: NSExtensionContext) {
    ...
    os_log(.default, "NativeSafari received native message: %{public}@", String(describing: message))

    var responseData: [String: Any] = [
      "status": "ok",
      "extensionName": "NativeSafari",
