...
Thin expo-targets example host for `authentication-services`.
...
# From repo root
bun install
cd examples/authentication-services
...
```bash
bun run examples:devicewright:matrix --ids=authentication-services
```
