...
Thin expo-targets example host for `unwanted-communication`.
...
# From repo root
bun install
cd examples/unwanted-communication
...
```bash
bun run examples:devicewright:matrix --ids=unwanted-communication
```
